          ...
          {monitors.map((m) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-2.5 h-2.5 rounded-full ${m.last_status === null ? "bg-zinc-600" : m.last_status ? "bg-green-400" : "bg-red-500"} shadow-lg`}
                  style={m.last_status ? { boxShadow: "0 0 8px #4ade80" } : {}}
                />
                <div>
